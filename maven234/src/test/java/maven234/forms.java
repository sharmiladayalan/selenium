...
public class forms {
  ...
  public void f() throws InterruptedException {
	  ...
	  Thread.sleep(3000);
	  wb.findElement(By.xpath("//*[@id=\"gender-radio-2\"]")).click();
	 Thread.sleep(3000);
	  //wb.findElement(By.name("//*[@id=\'userNumber\']")).sendKeys("9898767890");
	  //Thread.sleep(3000);
	  wb.findElement(By.id("dateOfBirthInput")).click();
	  Thread.sleep(3000);
	  ...
	  Thread.sleep(3000);
	  wb.findElement(By.xpath("//*[@id=\"subjectsContainer\"]/div/div[1]")).sendKeys("computer");
	  Thread.sleep(3000);
